...
export default function VendorStaff() {
  ...
  const fetchRoles = async () => {
    try {
      const response = await vendorRolesAPI.getAll({ isActive: 'true' });
  ...
  const handleViewStaff = async (id) => {
    ...
    setIsModalOpen(true);
    try {
      const response = await vendorStaffAPI.getById(id);
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await vendorStaffAPI.create(data);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await vendorStaffAPI.update(selectedStaff._id, data);
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <label className="cursor-pointer">
                  <div className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center gap-2 text-gray-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{selectedStaff.name || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{selectedStaff.email || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{selectedStaff.phone || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              {selectedStaff.location && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{selectedStaff.location}</p>
                  </div>
                </div>
              )}
