...
export const Roles = () => {
  ...
  const fetchAvailablePermissions = async () => {
    try {
      ...
      // Fallback to common permissions if API fails
      setAvailablePermissions([
        ...
        'view_bookings', 'edit_bookings', 'view_leads', 'edit_leads',
        'view_payouts', 'view_analytics', 'view_settings', 'edit_settings',
        ...
        'view_company', 'edit_company', 'view_contacts', 'edit_contacts', 'delete_contacts',
  ...
  const handleEditRole = (id) => {
    navigate(`/admin/roles?mode=edit&id=${id}`);
  };
  ...
  const handleUpdate = async () => {
    ...
    setActionLoading(true);
    try {
      await rolesAPI.update(selectedRole._id, formData);
  ...
  const getCategoryLabel = (category) => {
    const labels = {
      ...
      legal_pages: 'Legal Pages Management',
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Enter role name (e.g., Manager, Support Staff)"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {Object.keys(permissionsByCategory).length > 0 ? (
                  ...
                  // Fallback: Show all permissions in a single list
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Button onClick={() => navigate('/admin/roles?mode=create')}>
