...
import decorationCategoryRoutes from './v1/decorationCategory.routes.js';
import menuRoutes from './v1/menu.routes.js';
import occasionSpecialRoutes from './v1/occasionSpecial.routes.js';
...
import homepageContentRoutes from './v1/homepageContent.routes.js';
...
router.use('/decoration-categories', decorationCategoryRoutes);
router.use('/menus', menuRoutes);
router.use('/occasion-specials', occasionSpecialRoutes);
...
router.use('/homepage-content', homepageContentRoutes);
